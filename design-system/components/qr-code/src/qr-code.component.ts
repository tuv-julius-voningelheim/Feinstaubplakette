...
export default class TsQrCodeComponent extends ComponentElement {
    ...
    generate() {
        ...
        // qr-creator ships as CJS; under ESM module resolution the default import
        // resolves to the module namespace rather than the class. Cast to the class type.
        (QrCreator as unknown as typeof import('qr-creator').default).render(
            {
                text: this.value,
                radius: this.radius,
