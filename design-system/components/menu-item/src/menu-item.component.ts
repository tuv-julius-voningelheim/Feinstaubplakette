...
import { SubmenuController } from '@components/menu-item/src/submenu-controller.js';
...
export default class TsMenuItemComponent extends ComponentElement {
    ...
    override render() {
        ...
        // Cache once per render — isSubmenu() calls hasSlotController.test() (DOM query)
        const hasSubmenu = this.isSubmenu();
        ...
        return html`
            <div
                ...
                class=${classMap({
                    ...
                    'menu-item--has-submenu': hasSubmenu,
