...
export default class TsRangeComponent extends ComponentElement implements ComponentFormControl {
    ...
    private handleChange() {
        this.dispatchEvent(
            new CustomEvent('ts-change', { detail: { value: this.value }, bubbles: true, composed: true }),
        );
    }
    ...
    private handleInput() {
        ...
        this.dispatchEvent(
            new CustomEvent('ts-input', { detail: { value: this.value }, bubbles: true, composed: true }),
        );
        this.syncRange();
    }
